...
class DialogApi
{
    ...
    {
        list($response) = $this->dialogOpenWithHttpInfo();
        return $response;
    }
     ...
     */
    public function dialogOpenWithHttpInfo()
    {
        $request = $this->dialogOpenRequest();
     ...
     */
    public function dialogOpenAsync()
    {
        return $this->dialogOpenAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dialogOpenAsyncWithHttpInfo()
    {
        $returnType = 'map[string,object]';
        $request = $this->dialogOpenRequest();
     ...
     */
    protected function dialogOpenRequest()
    {
